...
import net.ibizsys.ocr.ibizutil.enums.RedisChannelTopic;
import net.ibizsys.ocr.ibizutil.cache.layering.LayeringCacheManager;
import net.ibizsys.ocr.ibizutil.cache.redis.KryoRedisSerializer;
import net.ibizsys.ocr.ibizutil.cache.redis.StringRedisSerializer;
import net.ibizsys.ocr.ibizutil.cache.setting.FirstCacheSetting;
