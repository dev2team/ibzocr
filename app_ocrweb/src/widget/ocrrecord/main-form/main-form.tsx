...
export default class Main extends Vue implements ControlInterface {
     ...
     * @memberof Main
     */
    public url: string = 'ocrweb/ocr/ocrrecord/maineditform/';
    ...
    public rules: any = {
        ...
        srfkey: [
            { required: false, type: 'string', message: '识别记录标识值不能为空!', trigger: 'change' }
        ],
        srfmajortext: [
            { required: false, type: 'string', message: '识别记录名称值不能为空!', trigger: 'change' }
        ],
        srftempmode: [
            { required: false, type: 'string', message: '值不能为空!', trigger: 'change' }
        ],
    ...
    public detailsModel: any = {
        group1: new FormGroupPanelModel({ caption: '识别记录基本信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'ocrrecord.main_form', extractMode: 'ITEM', details: [] } })
, 
        formpage1: new FormPageModel({ caption: '基本信息', detailType: 'FORMPAGE', name: 'formpage1', visible: true, isShowCaption: true, form: this })
, 
        group2: new FormGroupPanelModel({ caption: '操作信息', detailType: 'GROUPPANEL', name: 'group2', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'ocrrecord.main_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
        srfkey: new FormItemModel({ caption: '识别记录标识', detailType: 'FORMITEM', name: 'srfkey', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
        srfmajortext: new FormItemModel({ caption: '识别记录名称', detailType: 'FORMITEM', name: 'srfmajortext', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
        ocrrecordname: new FormItemModel({ caption: '识别记录名称', detailType: 'FORMITEM', name: 'ocrrecordname', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
        ocrrecordid: new FormItemModel({ caption: '识别记录标识', detailType: 'FORMITEM', name: 'ocrrecordid', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
    ...
    /**
     * 监控表单属性 ocrrecordname 值
     *
     * @param {*} newVal
     * @param {*} oldVal
     * @memberof Main
     */
    @Watch('data.ocrrecordname')
    onOcrrecordnameChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'ocrrecordname', newVal: newVal, oldVal: oldVal });
    }
    ...
    /**
     * 监控表单属性 ocrrecordid 值
     *
     * @param {*} newVal
     * @param {*} oldVal
     * @memberof Main
     */
    @Watch('data.ocrrecordid')
    onOcrrecordidChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'ocrrecordid', newVal: newVal, oldVal: oldVal });
    }
            ...
            <tab-pane name='formpage1' index={0} tab='form' class=''  
                label={
                    (h: any) => {
                        return (
                            <span class='caption'>
                                {this.$t('ocrrecord.main_form.details.formpage1')}
                            </span>
                        );
                    }
                }>
                
    <i-col v-show={this.detailsModel.group1.visible} style=''  xl={{ span: 24, offset: 0 }}>
    <app-form-group layoutType="TABLE_24COL" class='' uiActionGroup={this.detailsModel.group1.uiActionGroup} on-groupuiactionclick={($event:any) => this.groupUIActionClick($event)} caption={this.$t('ocrrecord.main_form.details.group1')} isShowCaption={true} uiStyle={'DEFAULT'} titleBarCloseMode={0} isInfoGroupMode={false}>
    <row>
        <i-col v-show={this.detailsModel.ocrrecordname.visible} style=''  xl={{ span: 24, offset: 0 }}>
    <app-form-item name='ocrrecordname' itemRules={JSON.stringify(this.rules.ocrrecordname)} class='' caption={this.$t('ocrrecord.main_form.details.ocrrecordname')} uiStyle='DEFAULT' labelWidth={130} isShowCaption={true} error={this.detailsModel.ocrrecordname.error} isEmptyCaption={false} labelPos='LEFT'> 
    <input-box v-model={this.data.ocrrecordname}  on-enter={($event: any) => this.onEnter($event)} disabled={this.detailsModel.ocrrecordname.disabled} type='string'  style=""></input-box>
</app-form-item>
            ...
            <tab-pane name='formpage2' index={1} tab='form' class=''  
                label={
                    (h: any) => {
                        return (
                            <span class='caption'>
                                {this.$t('ocrrecord.main_form.details.formpage2')}
                            </span>
                        );
                    }
                }>
                
    <i-col v-show={this.detailsModel.group2.visible} style=''  xl={{ span: 24, offset: 0 }}>
    <app-form-group layoutType="TABLE_24COL" class='' uiActionGroup={this.detailsModel.group2.uiActionGroup} on-groupuiactionclick={($event:any) => this.groupUIActionClick($event)} caption={this.$t('ocrrecord.main_form.details.group2')} isShowCaption={true} uiStyle={'DEFAULT'} titleBarCloseMode={0} isInfoGroupMode={false}>
    <row>
        <i-col v-show={this.detailsModel.createman.visible} style=''  xl={{ span: 24, offset: 0 }}>
    <app-form-item name='createman' itemRules={JSON.stringify(this.rules.createman)} class='' caption={this.$t('ocrrecord.main_form.details.createman')} uiStyle='DEFAULT' labelWidth={130} isShowCaption={true} error={this.detailsModel.createman.error} isEmptyCaption={false} labelPos='LEFT'> 
    <span style="">{this.data.createman}</span>
</app-form-item>

</i-col>
<i-col v-show={this.detailsModel.createdate.visible} style=''  xl={{ span: 24, offset: 0 }}>
    <app-form-item name='createdate' itemRules={JSON.stringify(this.rules.createdate)} class='' caption={this.$t('ocrrecord.main_form.details.createdate')} uiStyle='DEFAULT' labelWidth={130} isShowCaption={true} error={this.detailsModel.createdate.error} isEmptyCaption={false} labelPos='LEFT'> 
    <span style="">{this.data.createdate}</span>
</app-form-item>

</i-col>
<i-col v-show={this.detailsModel.updateman.visible} style=''  xl={{ span: 24, offset: 0 }}>
    <app-form-item name='updateman' itemRules={JSON.stringify(this.rules.updateman)} class='' caption={this.$t('ocrrecord.main_form.details.updateman')} uiStyle='DEFAULT' labelWidth={130} isShowCaption={true} error={this.detailsModel.updateman.error} isEmptyCaption={false} labelPos='LEFT'> 
    <span style="">{this.data.updateman}</span>
</app-form-item>

</i-col>
<i-col v-show={this.detailsModel.updatedate.visible} style=''  xl={{ span: 24, offset: 0 }}>
    <app-form-item name='updatedate' itemRules={JSON.stringify(this.rules.updatedate)} class='' caption={this.$t('ocrrecord.main_form.details.updatedate')} uiStyle='DEFAULT' labelWidth={130} isShowCaption={true} error={this.detailsModel.updatedate.error} isEmptyCaption={false} labelPos='LEFT'> 
